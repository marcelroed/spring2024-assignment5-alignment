...
def run_inference_single_gpu(gpu_id, prompt_list, model_name, sampling_params):
...
class MultiLLM:
    ...
    def init_and_generate(self, prompts: list[str], sampling_params: SamplingParams):
        ...
        inputs = [(i, p, self.model_name, sampling_params) for i, p in enumerate(split_prompts)]
